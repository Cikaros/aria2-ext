...
const config = {
    ...
    BASE_URL: process.env.BASE_URL || 'https://cikaros.top',
    ...
    ADMIN_ID: process.env.ADMIN_ID || '@cikaros:cikaros.top',
    USER_ID: process.env.USER_ID || '@bot:cikaros.top',
    PASSWORD: process.env.PASSWORD || '',
    INTERVAL_TIMEOUT: process.env.INTERVAL_TIMEOUT || 60 * 1000,
    RSS_TIMEOUT: process.env.RSS_TIMEOUT || 10 * 1000,
    ARIA2_HOST: process.env.ARIA2_HOST || 'aria2.cikaros.com',
